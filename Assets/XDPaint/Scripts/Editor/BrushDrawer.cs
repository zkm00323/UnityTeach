...
namespace XDPaint.Editor
{
    ...
    {
        private float MarginBetweenFields { get { return EditorGUIUtility.standardVerticalSpacing; } }
        private float SingleLineHeight { get { return EditorGUIUtility.singleLineHeight; } }
        private float SingleLineHeightWithMargin { get { return SingleLineHeight + MarginBetweenFields; } }
        ...
        {
            return PropertyDrawerUtility.GetActualObjectForSerializedProperty<Brush>(fieldInfo, property);
        }
        ...
        public override float GetPropertyHeight(SerializedProperty property, GUIContent label)
        {
            ...
            if (brush != null)
            {
                ...
                if (brushTexture != null)
                {
                    textureHeight = Mathf.Clamp(brushTexture.height, 1f, 192f) + BrushDrawerHelper.LineOffset * 2f;
                }
            }
        ...
        private void DrawTexture()
        {
            ...
            var width = Mathf.Clamp(brushTexture.width, 1f, 144f);
            var height = Mathf.Clamp(brushTexture.height, 1f, 144);
